...
import twitterLogo from "../../public/assets/icons8-twitterx.svg"
import githubLogo from "../../public/assets/github-142-svgrepo-com.svg"
import mailLogo from "../../public/assets/mail-svgrepo-com.svg"
  ...
  return (
    <section className=" hero w-full bg-fourth py-36 flex flex-col justify-center items-center px-2 relative">
      ...
      <div className="logos flex justify-center items-center gap-6 w-full pt-8 ">
        ...
        <Image src={linkedinLogo} alt="linkedin" width={25} height={25} loading='eager'/>
        </Link>
        <Link href="https://www.instagram.com/raaaa.aj_24?igsh=MzNlNGNkZWQ4Mg==" target="_blank" passHref={true} className="z-40">
        <Image src={instagramLogo} alt="instagram" width={25} height={25} loading='eager'/>
        </Link>
        <Link href="https://x.com/raaaaj214?t=tEwNSFMYYkW-y_933PdWEw&s=08" target="_blank" passHref={true} className="z-40">
        <Image src={twitterLogo} alt="instagram" width={25} height={25} loading='eager'/>
        </Link>    
        <Link href="https://github.com/raaaaj214" target="_blank" passHref={true} className="z-40">
        <Image src={githubLogo} alt="instagram" width={25} height={25} loading='eager'/>
        </Link>    
        <Link href="mailto:rajdeshmukh41705@gmail.com" target="_self" passHref={true} className="z-40">
        <Image src={mailLogo} alt="Mail" width={30} height={25} loading='eager'/>
        </Link>    
          </div>
